...
class EmergencyWaitingState extends Equatable {
  const EmergencyWaitingState({
    this.longitude = 35.876200,
    this.latitude = 32.023150,
    this.status = EmergencyWaitingStatus.emergencyDetails,
    this.loading = false,
    this.emergencyType,
  ...
  EmergencyWaitingState copyWith({
    double? longitude,
    double? latitude,
    EmergencyWaitingStatus? status,
    bool? loading,
